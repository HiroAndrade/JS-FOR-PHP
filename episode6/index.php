...
<body class="bg-gray-900 min-h-screen">
        ...
        <div class="w-full flex gap-2 justify-center">
            <form id="settings-form">
                ...
                <div class="mb-3">
                    ...
                    <label for="allow-duplicates-checkbox">Allow duplicates guesses</label>
                </div>


                <div id="options-custom" class="hidden">
                    <input type="text" id="input-title" placeholder="Game Title" class="border p-2 w-40 bg-gray-900 disabled:opacity-50">
                    <input type="text" id="input-min-range" placeholder="Min Range" class="border p-2 w-40 bg-gray-900 disabled:opacity-50">
                    <input type="text" id="input-max-range" placeholder="Max Range" class="border p-2 w-40 bg-gray-900 disabled:opacity-50">
                    <input type="text" id="input-max-attempts" placeholder="Max Attempts" class="border p-2 w-40 bg-gray-900 disabled:opacity-50">
                </div>

                <div  id="options-mode" class="inline">
                    <select name="game-level" id="game-level" class="border p-2 bg-gray-900 disabled:opacity-50">
                        <option data-min-range='1' data-max-range='10' data-attempts='3' value="easy">Easy</option>
                ...
                <button name="play-game" id="play-game" class="bg-blue-500 hover:bg-blue-700 disabled:bg-blue-500 disabled:opacity-50 text-white font-bold py-2 px-4">
                    Play Game
                </button>
                <button name="clear-game" id="clear-game" class="bg-gray-500 hover:bg-gray-700 disabled:bg-gray-500 disabled:opacity-50 text-white font-bold py-2 px-4">
                    Clear
                </button>
            </form>
        </div>
    ...
    <script src="./episode-06.js" type="module"></script>
</body>
