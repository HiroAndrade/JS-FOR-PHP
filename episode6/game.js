...
export default class Game {
  ...
  static initRangeValues({ value, lowerBounds, upperBounds = 0 } = {}) {
    ...
    if (num && upperBounds > upperBounds) {
      throw {
  ...
  play() {
    ...
    console.log(
      `Game Over! The secret number is ${this.secretNumber}, and you ${guessedMessage} in ${history.length} attempts`
    );
